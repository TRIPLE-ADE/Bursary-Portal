...
<!-- Mirrored from investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/billing.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 07:23:26 GMT -->
<head>
  <meta charset="utf-8">
				  ...
				  <div class="box">
					<div class="box-body">
						<div class="d-md-flex d-block align-items-center justify-content-between">
							...
							<a href="#" class="btn btn-primary"><i class="fa fa-download me-10"></i>Get Statement</a>
						</div>
					</div>
				  </div>
				</div>
