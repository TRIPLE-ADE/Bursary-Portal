...
<!-- Mirrored from investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/ui_buttons.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 07:22:29 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>InvestX - Dashboard  Button UI </title>
						  ...
						  <p class="subtitle mb-20">Use a classes <code>waves-effect waves-light btn btn-social btn-bitbucket /  &lt; class="fa fa-bitbucket"&gt;&lt;/i&gt;</code> to quickly create a General btn.</p>
							<div class="clearfix">					
							  ...
							  <button class="waves-effect waves-light btn btn-social btn-twitter mb-5">
								<i class="me-10 fa fa-twitter"></i> Sign in with Twitter
							  </button>
						...
						<div class="box-body">
						  ...
						  <p class="subtitle mb-20">Use a classes <code>waves-effect waves-light btn btn-social-icon btn-bitbucket-light</code></p>
							<div class="clearfix">
								...
								<button class="waves-effect waves-light btn btn-social-icon btn-twitter-light"><i class="fa fa-twitter"></i></button>
						...
						<div class="box-body">
						  ...
						  <p class="subtitle mb-20">Use a classes <code>btn btn-social-icon btn-circle</code> to quickly create a General btn.</p>
							<div class="clearfix">
								...
								<button class="waves-effect waves-circle btn btn-social-icon btn-circle btn-twitter-light"><i class="fa fa-twitter"></i></button>
