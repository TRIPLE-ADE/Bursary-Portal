...
<!-- Mirrored from investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/widgets_social.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 07:23:33 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>InvestX - Dashboard  Social Widgets</title>
			  	...
			  	<div class="box">
					...
					<div class="box-body">
						...
						<ul class="list-inline text-center text-fade">
							...
							<li><a href="javascript:void(0)" data-bs-toggle="tooltip" title="twitter" class="text-fade hover-primary"><i class="fa fa-twitter fs-20"></i></a></li>
			  ...
			  <div class="col-md-6 col-lg-4">
				<div class="box p-30 pt-50 text-center">
				  ...
				  <div class="gap-items">
					...
					<a class="text-twitter btn btn-circle btn-twitter" href="#"><i class="fa fa-twitter"></i></a>
				  </div>
				</div>
			  </div>
			  <div class="col-lg-4 col-12">
				<div class="box">
				  <div class="text-white box-body bg-img text-center py-50" style="background-image: url(../../../images/gallery/creative/img-14.jpg);" data-overlay="5">
					<a href="#">
				...
				<a class="box box-body box-hover-shadow" href="#">
				  <div class="flexbox align-items-center">
					...
					<div class="text-end">
					  ...
					  <small class="text-fade">Manager</small>
					</div>
				  </div>
				</a>
			  </div>
				  ...
				  <div class="box box-inverse box-success">
					<div class="box-body">
					  ...
					  <div>
						...
						<div class="fs-14 mb-10">Manager</div>
...
<!-- Mirrored from investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/widgets_social.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 07:23:35 GMT -->
</html>
