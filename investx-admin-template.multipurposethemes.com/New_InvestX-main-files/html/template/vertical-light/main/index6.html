...
<!-- Mirrored from investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/index6.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 07:22:12 GMT -->
<head>
    <meta charset="utf-8">
  ...
  <div class="content-wrapper">
	  <div class="container-full">
					...
					<div class="row mb-3">
						<div class="" href="#">
				  			<div class="d-flex align-items-center">
									<img class="avatar avatar-lg" src="../../../images/avatar/21.jpg" alt="..." style="margin: 8px 0px 0px 0px;">
									<div class="mx-3">
						  				<h3 class="mb-0">Prudential Technology Direct Plan-Growth.</h3>
						  				<button class="btn btn-xs btn-light">Equity</button>
											<button class="btn btn-xs btn-light">Technology</button>
									</div>
				  			</div>
						</div>
					</div>
					...
					<div class="box">
						<div class="box-body">
							<div class="row">
								...
								<div class="col-lg-4">
									<h3 class="mt-0">Scheme Rating</h3>
									<a class="box box-body box-hover-shadow mb-3" href="#">
						  				<div class="d-flex align-items-center">
											<i class="ti-medall" style="font-size: 40px;"></i>
											<h1>2</h1>
											<div class="mx-3">
							  					<h6 class="mt-3">Technology</h6>
							  					<p class="text-fade">5Y Returns</p>
											</div>
						  				</div>
									</a>
								</div>
					...
					<div class="box">
						<div class="box-body">
								...
								<div class="row mb-3">
									<a class="" href="#">
							  			<div class="d-flex align-items-center">
											...
											<div class="mx-3">
								  				<h3 class="mb-0">Prudential Technology Direct Plan-Growth.</h3>
								  				<p class="text-fade">as of 31 Aug 2021 , 5:30 Am</p>
											</div>
							  			</div>
									</a>
								</div>
							...
							<div>
								<div class="row">
									<div class="col-lg-5">
										<p class="text-fade">Scheme Assetsize</p>
										<h3>$5,037.40</h3>
									</div>
									<div class="col-lg-4">
										<p class="text-fade">Expencse Ratio</p>
										<h3>0.96%</h3>
									</div>
									<div class="col-lg-3">
										<p class="text-fade">Cash Holding</p>
										<h3>7.96%</h3>
									</div>
								</div><br>
								<div class="row">
									<div class="col-lg-5">
										<p class="text-fade">Fund Type</p>
										<h3>Open-End</h3>
									</div>
									<div class="col-lg-4">
										<p class="text-fade">Plan</p>
										<h3>Growth</h3>		
									</div>
									<div class="col-lg-3">
										<p class="text-fade">Benchmark</p>
										<h3>S&P BSE IT Total Return Index</h3>		
									</div>
								</div><br>
								<div class="row">
									<div class="col-lg-9">
										<p class="text-fade">Exit load</p>
										<h3>Exit load of 1% if redeemed within 15 day.</h3>
									</div>
									<div class="col-lg-3">
										<p class="text-fade">Scheme Document</p>
										<h3 class="text-primary">View</h3>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="box">
						<div class="box-body">
							<div class="d-md-flex justify-content-between align-items-center">
								<div>
									<h3 class="m-0">Funds in this category</h3>
								</div>
								<div class="mx-lg-5">
						...
						<div class="p-4 fund_returns " >
							<div class="d-md-flex justify-content-between align-items-center">
								<div>
									<h3 class="m-0 text-dark">This fund's returns : <span class="text-success">+37.98%</span></h3>
								</div>
								<div class=" mx-lg-5">
										<a href="#" class="waves-effect waves-light btn btn-outline btn-primary m-1 mx-lg-5">3 Years</a>
								</div>
							</div>
						</div>
						<div class="box-body">
							<div class="row mb-1">
								<div class="row mb-3">
									<div class="" href="#">
							  			<div class="d-flex align-items-center mt-20">
											<img class="avatar avatar-lg" src="../../../images/avatar/21.jpg" alt="..." style="margin: 8px 0px 0px 0px;">
											<div class="mx-3">
								  				<h3>Digital Fund Direct-Growth.</h3>
								  				<div>
									  				<button class="btn btn-xs btn-light">Equity</button>
													<button class="btn btn-xs btn-light">Technology</button>
												</div>
								...
								<div class="row">
									<div class="col-lg-4">
										<p class="text-fade">Min. Investment</p>
										<h3>$100</h3>
									</div>
									<div class="col-lg-8">
										<div class="d-flex justify-content-between">
											<div>
												<p class="text-fade m-0">Category Returns</p>
												<div>29.60%
													<div class="progress progress-lg">
														<div class="progress-bar bg-warning" role="progressbar" style="width: 29.60%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
													</div>
												</div>
											</div>
											<div class="text-end">
												<p class="text-fade">3Y Returns</p>
												<h3 class="text-success">+37.74%</h3>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row mb-3">
									<div class="" href="#">
							  			<div class="d-flex align-items-center">
											<img class="avatar avatar-lg" src="../../../images/avatar/21.jpg" alt="..." style="margin: 8px 0px 0px 0px;">
											<div class="mx-3">
								  				<h3>Technology Fund Direct-Growth.</h3>
								  				<button class="btn btn-xs btn-light">Equity</button>
												<button class="btn btn-xs btn-light">Technology</button>
											</div>
							  			</div>
									...
									<div class="col-lg-8">
										<div class="d-flex justify-content-between">
											<div>
												...
												<div>40.60%
													<div class="progress progress-lg">
														<div class="progress-bar bg-warning" role="progressbar" style="width: 40.60%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
													</div>
												</div>
											</div>
											<div class="text-end">
												<p class="text-fade">3Y Returns</p>
												<h3 class="text-success">+33.74%</h3>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row mb-3">
									<div class="" href="#">
							  			<div class="d-flex align-items-center">
											<img class="avatar avatar-lg" src="../../../images/avatar/21.jpg" alt="..." style="margin: 8px 0px 0px 0px;">
											<div class="mx-3">
								  				<h3>PHP Digital Fund Direct-Growth.</h3>
								  				<button class="btn btn-xs btn-light">Equity</button>
												<button class="btn btn-xs btn-light">Technology</button>
											</div>
							  			</div>
									...
									<div class="col-lg-8">
										<div class="d-flex justify-content-between">
											<div>
												...
												<div>50.60%
													<div class="progress progress-lg">
														<div class="progress-bar bg-warning" role="progressbar" style="width: 50.60%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
													</div>
												</div>
											</div>
											<div class="text-end">
												<p class="text-fade">3Y Returns</p>
												<h3 class="text-success">+33.56%</h3>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="col-lg-8">
										<div class="d-flex justify-content-between">
											<div>
												...
												<div>89.60%
													<div class="progress progress-lg">
														<div class="progress-bar bg-warning" role="progressbar" style="width: 89.60%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
													</div>
												</div>
											</div>
											<div class="text-end">
												<p class="text-fade">3Y Returns</p>
												<h3 class="text-success">+45.56%</h3>
											</div>
										</div>
									</div>
								</div>
				...
				<div class="col-xl-3 col-12">
					<div class="box">
						<div class="box box-body m-0">
							<h3>Start SIP In This Online Fund</h3>
							...
							<div class="flexbox align-items-center">
								<h3>$100</h3>
								<h3>1st<small class="text-fade"> Of Every Month</small></h3>
							</div><hr>
					...
					<div class="box">
						<div class="box box-body">
							...
							<div class="text-center">
								...
								<p class="text-fade">Would have given a return of</p>
							</div>
							<div>
								<div id="spark2"></div>
							</div>
						...
						<div class="cd-horizontal-timeline loaded m-0">
							<div class="timeline">
								<div class="text-center">
										<p class="text-fade">in the last</p>
									</div>
								<div class="events-wrapper">
									<div class="events" style="width: 100%;">
										<ol>
											<li><a href="#0" data-date="1m" class="selected" style="left: 20%;">1m</a></li>
											<li><a href="#0" data-date="3m" class="selected" style="left: 40%;">3m</a></li>
											<li><a href="#0" data-date="1m" class="selected" style="left: 50%;">1Y</a></li>
											<li><a href="#0" data-date="1m" class="selected" style="left: 60%;">3Y</a></li>
											<li><a href="#0" data-date="1m" style="left: 70%;">5Y</a></li>
											<li><a href="#0" data-date="1m" style="left: 80%;">max</a></li>
										</ol> <span class="filling-line" aria-hidden="true" style="transform: scaleX(0.62);"></span> 
									</div>
								</div>
							</div>
						</div><hr>
						<div class="text-fade text-center">
							<h3 class="text-dark">+1% <small class="text-fade">Higher Return</small></h3>
							<p>With Direct Plans On Online Money</p>
						</div>
					...
					<div class="box">
						<div class="box-body">
							<div class="row">
								<div class="col-lg-12 col-sm-7 investment">
								...
								<div class="col-lg-12 col-sm-5 meter">
		...
		<section>
			<div class="box-body">
				<div class="col-lg-9">
					<h3>About Prudential Techonology Direct Plan-Growth.</h3>
					<p class="text-light">Ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
					...
					<div class="row">
						<div class="col-lg-12 text-fade">
							<p>AUM : <span class="text-first">$5,037.40</span></p>
							<p>Category : <span class="text-left">Equity : sectoral-techonology</span></p>
							<p>Lunch Date : <span class="text-left">01 Jan 2021</span></p>
							<p>Fund Type : <span class="text-left">Open-End</span></p>
						</div>
						
					</div><br>
					<h3>Scheme Objective</h3>
					<p class="text-light">Ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
						tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
						quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
						consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
					...
					<h3>AMU Information</h3>
					<div class="row">
						<div class="col-lg-5 mb-10">
							<div class="d-flex align-items-center">
								<img class="avatar avatar-lg" src="../../../images/avatar/21.jpg" alt="..." style="margin: 8px 0px 0px 0px;">
								<div class="mx-3">
								  	<h3 class="mb-0">Prudential Funds.</h3>
								</div>
							</div>
						</div>
						<div class="col-lg-4">
							<h3 class="text-dark">$4,56,707.77</h3>
							<p class="text-fade">AUM</p>
						</div>
						<div class="col-lg-3">
							<h3 class="text-dark">247</h3>
							<p class="text-fade">Scheme</p>
						</div>

						<div class="col-lg-5 text-fade px-2">
							<div class="d-flex"> 
								<div>
									<i class="mdi mdi-account-location" style="font-size: 30px;"></i>
								</div>
								<div class="pt-3 px-1">
									<p>Insum dolor,123,c96</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 text-fade px-0">
							<div class="d-flex"> 
								<div>
									<i class="mdi mdi-cellphone-basic" style="font-size: 30px;"></i>
								</div>
								<div class="pt-3 px-1">
									<p>022-265-200502</p>
								</div>
						...
						<div class="col-lg-3 text-fade px-2">
							<div class="d-flex"> 
								<div>
									<i class="mdi mdi-email-outline" style="font-size: 30px;"></i>
								</div>
								<div class="pt-3 px-1">
									<p>info@email.com</p>
								</div>
