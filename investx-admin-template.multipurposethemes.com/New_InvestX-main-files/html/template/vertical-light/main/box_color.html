...
<!-- Mirrored from investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/box_color.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 07:22:21 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>InvestX - Dashboard  Box color </title>
			  ...
			  <div class="col-12">
				<div class="box bg-primary-light">
				  <div class="box-body">
					...
					<p class="text-gray-600">Each box can accpet <code>.box-*</code> class that <b>*</b> is a <a href="https://investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/ui/general.html" target="_blank">color name</a>. To make the color texts white, you should also add <code>.box-inverse</code> to the <em>.box</em> tag.</p>
				  </div>
				</div>
			  </div>
