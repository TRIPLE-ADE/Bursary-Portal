...
<!-- Mirrored from investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 07:22:04 GMT -->
<head>
    <meta charset="utf-8">
					...
					<div class="row">	
						<div class="col-xl-6 col-lg-6 col-12">
							<div class="box box-body pull-up Sales_Profit">	
								<div class="row">
									<div class="col-8">
										<h4 class="hover-primary"><i class="fa fa-fw fa-gg-circle text-primary"></i> Portfolio</h4>
						...
						<div class="col-xl-6 col-lg-6 col-12">
							<div class="box box-body pull-up Sales_Profit ">
								<div class="row">
									<div class="col-8 ">
										<h4 class="hover-success"><i class="fa fa-fw fa-gg-circle text-primary"></i> Sales Profit</h4>
										<div class="d-flex">
											<p class="fs-35 fw-600 mb-0">$159,348 </p>
									  		<div class="text-end mt-20 fs-13"><i class="fa fa-sort-up text-success me-1"></i> 3.5%</div>
										</div>
									</div>
									<div class="col-4 text-end" style="position: relative;">
...
<!-- Mirrored from investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 07:22:07 GMT -->
</html>
