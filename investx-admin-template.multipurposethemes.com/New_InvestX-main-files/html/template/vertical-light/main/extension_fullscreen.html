...
<!-- Mirrored from investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/extension_fullscreen.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 07:22:47 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>InvestX - Dashboard  Extension Fullscreen </title>
	  ...
	  <div class="container-full">
		...
		<section class="content">
		  ...
		  <div class="box">
			...
			<div class="box-body">
				<p class="text-fade">Simple wrapper for cross-browser usage of the JavaScript Fullscreen API, which lets you bring the page into fullscreen.<a href="https://github.com/sindresorhus/screenfull.js/" target="_blank" class="pull-right">Official documentation</a></p>
