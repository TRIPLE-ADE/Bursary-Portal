...
<!-- Mirrored from investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/index4.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 07:22:08 GMT -->
<head>
    <meta charset="utf-8">
 ...
 <link rel="stylesheet" href="../src/css/responsive.html">
		...
		<section class="content">
			<div class="row">
					...
					<div class="row">
									...
									<div class="d-flex align-items-center justify-content-between">
										<div class="d-flex align-items-center">
											<div class="bg-warning h-50 w-50 product_icon text-center">
												<p class="mb-0 fs-20 w-50 fw-600 l-h-45"><i class="fa fa-shopping-cart" aria-hidden="true"></i></p>
											</div>
											<div class="d-flex flex-column font-weight-500 mx-10">
												<a href="#" class="text-dark hover-primary mb-1  fs-17">Buy</a>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="box-body">
									<div class="d-flex align-items-center justify-content-between">
										<div class="d-flex align-items-center">
											...
											<div class="d-flex flex-column font-weight-500 mx-10">
												<a href="#" class="text-dark hover-primary mb-1  fs-17">Sell</a>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="box-body">
									<div class="d-flex align-items-center justify-content-between">
										<div class="d-flex align-items-center">
											...
											<div class="d-flex flex-column font-weight-500 mx-10">
												<a href="#" class="text-dark hover-primary mb-1  fs-17">Send</a>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="box-body">
									<div class="d-flex align-items-center justify-content-between">
										<div class="d-flex align-items-center">
											...
											<div class="d-flex flex-column font-weight-500 mx-10">
												<a href="#" class="text-dark hover-primary mb-1  fs-17">Request</a>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="col-xl-12">
							<div class="card chart_card">
								<div class="card-body">
									<div class="mt-0">
										<h4 class="fw-500">Current Value</h4>
										<h3 class="fw-500 m-0">Rp 11,900,204</h3>
									</div>
									<div class="p-0">
										<div class="box-controls pull-right mb-15">
											<ul class="nav nav-pills nav-pills-sm" role="tablist">
												<li class="nav-item">
													<a class="nav-link py-2 px-3 b-0" data-bs-toggle="tab" href="#">
														<span class="nav-text base-font">1d</span>
													</a>
												</li>
												<li class="nav-item">
													<a class="nav-link py-2 px-3 b-0" data-bs-toggle="tab" href="#">
														<span class="nav-text base-font">7d</span>
													</a>
												</li>
												<li class="nav-item">
													<a class="nav-link py-2 px-3 b-0 active" data-bs-toggle="tab" href="#">
														<span class="nav-text base-font">1m</span>
													</a>
												</li>
												<li class="nav-item">
													<a class="nav-link py-2 px-3 b-0" data-bs-toggle="tab" href="#">
														<span class="nav-text base-font">1y</span>
													</a>
												</li>
												<li class="nav-item">
													<a class="nav-link py-2 px-2 b-0" data-bs-toggle="tab" href="#">
														<span class="nav-text base-font mz-0">Max</span>
													</a>
												</li>
											</ul>
										</div>
						...
						<div class="col-xl-4 col-lg-6">
							<div class="card widget-flat following_box">
								<div class="card-body follow_box" style="position: relative;">
									<div class="d-flex align-items-center justify-content-between">
										<div class="d-flex align-items-center">
											<div class="bg-warning h-50 w-50 product_icon text-center">
												<p class="mb-0 fs-30 w-50 fw-600 l-h-45"><i class="fa fa-fw fa-bitcoin"></i></p>
											</div>
											<div class="d-flex flex-column font-weight-500 mx-5">
												<a href="#" class="text-dark hover-primary mb-1  fs-17">Bitcoin</a>
											</div>
										</div>
										<div>
											<div class="d-flex flex-column font-weight-500">
												<span class="float-end"><a class="btn btn-xs btn-primary-light" href="#">24 h</a></span>
											</div>
										</div>
									</div>
									<div class="d-flex align-items-center justify-content-between mt-10 mb-30">
										<div class="d-flex align-items-center">
											<div class="d-flex flex-column font-weight-500 mx-5">
												<a href="#" class="text-dark hover-primary mb-1  fs-19">Rp 459,852</a>
											</div>
										</div>
										<div>
											<div class="d-flex flex-column font-weight-500">
												<span class="float-end"><a class="btn btn-xs btn-success-light" href="#"><i class="fa fa-sort-up text-success me-1"></i> 4.5%</a></span>
											</div>
										</div>
									</div>
									<div id="spark_1" class="apex-charts mb-3" style="min-height: 100px;"></div>
									<div class="resize-triggers">
										<div class="expand-trigger"><div style="width: 388px; height: 278px;"></div></div><div class="contract-trigger"></div>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card widget-flat following_box">
								<div class="card-body follow_box" style="position: relative;">
									<div class="d-flex align-items-center justify-content-between">
										<div class="d-flex align-items-center">
											<div class="bg-danger h-50 w-50 product_icon text-center">
													<p class="mb-0 fs-30 w-50 fw-600 l-h-50"><i class="fa fa-fw fa-sheqel"></i></p>
												</div>
											<div class="d-flex flex-column font-weight-500 mx-5">
												<a href="#" class="text-dark hover-primary mb-1  fs-17">Dogecoin</a>
											</div>
										</div>
										<div>
											<div class="d-flex flex-column font-weight-500">
									...
									<div class="d-flex align-items-center justify-content-between mt-10 mb-30">
										<div class="d-flex align-items-center">
											<div class="d-flex flex-column font-weight-500 mx-5">
												<a href="#" class="text-dark hover-primary mb-1  fs-19">Rp 987,226</a>
											</div>
										</div>
										<div>
											<div class="d-flex flex-column font-weight-500">
												<span class="float-end"><a class="btn btn-xs btn-success-light" href="#"><i class="fa fa-sort-up text-success me-1"></i> 7.5%</a></span>
											</div>
										</div>
									</div>
									<div id="spark_2" class="apex-charts mb-3" style="min-height: 100px;"></div>
									<div class="resize-triggers">
										<div class="expand-trigger"><div style="width: 388px; height: 278px;"></div></div><div class="contract-trigger"></div>
									</div>
								</div>
							...
							<div class="card widget-flat following_box">
								<div class="card-body follow_box" style="position: relative;">
									<div class="d-flex align-items-center justify-content-between">
										<div class="d-flex align-items-center">
											<div class="bg-info h-50 w-50 product_icon text-center">
													<p class="mb-0 fs-30 w-50 fw-600 l-h-45"><i class="fa fa-fw fa-gbp"></i></p>
												</div>
											<div class="d-flex flex-column font-weight-500 mx-5">
												<a href="#" class="text-dark hover-primary mb-1  fs-17">Ethereum</a>
											</div>
										</div>
										<div>
											<div class="d-flex flex-column font-weight-500">
									...
									<div class="d-flex align-items-center justify-content-between mt-10 mb-30">
										<div class="d-flex align-items-center">
											<div class="d-flex flex-column font-weight-500 mx-5">
												<a href="#" class="text-dark hover-primary mb-1  fs-19">Rp 265,226</a>
											</div>
										</div>
										<div>
											<div class="d-flex flex-column font-weight-500">
												<span class="float-end"><a class="btn btn-xs btn-danger-light" href="#"><i class="fa fa-sort-down text-danger me-1"></i> 2.5%</a></span>
											</div>
										</div>
									</div>
									<div id="spark_3" class="apex-charts mb-3" style="min-height: 100px;"></div>
									<div class="resize-triggers">
										<div class="expand-trigger"><div style="width: 388px; height: 278px;"></div></div><div class="contract-trigger"></div>
									</div>
								</div>
				...
				<div class="col-xl-4 col-12 ">
					<div class="box" style="height: 75.8rem;">
						<div class="box-body activ_box">							
							<div class="box no-shadow mb-0 px-10">
								<div class="box-header no-border">
									<h4 class="box-title fw-500">My Portfolio</h4>							
									<div class="box-controls pull-right d-md-flex">
									  <a href="#" class="mx-10 btn btn-xs btn-primary-light">Chat</a>
									  <a href="#" class="btn btn-xs btn-primary-light">List</a>
									</div>
								</div>
							</div>
							<div class="px-10">
								<div class="box mb-15 pull-up">
									<div class="box-body ">
										<div class="d-flex align-items-center justify-content-between">
											...
											<div>
												<div class="d-flex flex-column font-weight-500">
													<a href="#" class="text-dark text-end hover-primary mb-1 fs-16">BTC0165</a>
													<span class="text-fade text-end">Rp 5,500</span>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="box-body">
										<div class="d-flex align-items-center justify-content-between">
											<div class="d-flex align-items-center">
												...
												<div class="d-flex flex-column font-weight-500 mx-10">
													<a href="#" class="text-dark hover-primary mb-1  fs-17">Ethereum</a>
													<span class="text-fade">ETH</span>
												</div>
											</div>
											<div>
												<div class="d-flex flex-column font-weight-500">
													<a href="#" class="text-dark text-end hover-primary mb-1 fs-16">ETH0158</a>
													<span class="text-fade text-end">Rp 4,200</span>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="box-body">
										<div class="d-flex align-items-center justify-content-between">
											<div class="d-flex align-items-center">
												...
												<div class="d-flex flex-column font-weight-500 mx-10">
													<a href="#" class="text-dark hover-primary mb-1  fs-17">Dogecoin</a>
													<span class="text-fade">DOGE</span>
												</div>
											</div>
											<div>
												<div class="d-flex flex-column font-weight-500">
													<a href="#" class="text-dark text-end hover-primary mb-1 fs-16">DOGE124</a>
													<span class="text-fade text-end">Rp 4,600</span>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="box mb-15">
									<div class="box-body activ_box">
										<div class="d-flex align-items-center justify-content-between">
											<div class="d-flex align-items-center">
												<div class="d-flex flex-column font-weight-500 mx-10">
													<span class="text-fade">Total Balance</span>
												</div>
											</div>
											<div>
												<div class="d-flex flex-column font-weight-500">
													<span class="text-dark">Rp 11,900,204</span>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="box no-shadow mb-0 px-0">
								<div class="box-header no-border px-0">
									<h4 class="box-title fw-500 m-0">Recent Activity</h4>							
								</div>
							</div>
							<div>
								<div class="mb-0">
									<div class="pb-20">
										<p class="fs-16">July 7</p>
										<div class="d-flex align-items-center justify-content-between">
											<div class="d-flex align-items-center">
												<div class="bg-transparent h-50 w-50 border border-light product_icon text-center">
												  	<p class="mb-0 fs-20 w-50 fw-600 l-h-40"><i class="fa fa-exchange" aria-hidden="true"></i></p>
												</div>
												<div class="d-flex flex-column font-weight-500 mx-10">
													<a href="#" class="text-dark hover-primary mb-1  fs-15">Bought Ethereum</a>
													<span class="text-fade"><i class="fa fa-fw fa-circle fs-10 text-success"></i> Success</span>
												</div>
											</div>
											<div>
												<div class="d-flex flex-column font-weight-500">
													<a href="#" class="text-dark text-end hover-primary mb-1 fs-16">+0,00024ETH</a>
													<span class="text-fade text-end">Rp 10,000</span>
												</div>
											</div>
										</div>
									</div>
									...
									<div class=" pb-20">
										...
										<div class="d-flex align-items-center justify-content-between">
											<div class="d-flex align-items-center">
												...
												<div class="d-flex flex-column font-weight-500 mx-10">
													<a href="#" class="text-dark hover-primary mb-1  fs-15">Bought Compound</a>
													<span class="text-fade"><i class="fa fa-fw fa-circle fs-10 text-success"></i> Success</span>
												</div>
											</div>
											<div>
												<div class="d-flex flex-column font-weight-500">
													<a href="#" class="text-dark text-end hover-primary mb-1 fs-16">+0,00032BTC</a>
													<span class="text-fade text-end">Rp 2,500</span>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="pb-20">
										...
										<div class="d-flex align-items-center justify-content-between">
											<div class="d-flex align-items-center">
												...
												<div class="d-flex flex-column font-weight-500 mx-10">
													<a href="#" class="text-dark hover-primary mb-1  fs-15">Received Bitcoin</a>
													<span class="text-fade"><i class="fa fa-fw fa-circle fs-10 text-success"></i> Success</span>
												</div>
											</div>
											<div>
												<div class="d-flex flex-column font-weight-500">
													<a href="#" class="text-dark text-end hover-primary mb-1 fs-16">+0,00056BTC</a>
													<span class="text-fade text-end">Rp 2,500</span>
												</div>
											</div>
										</div>
								...
								<div class="activ_box_button " style="width: 100%;">
									<button class="btn btn-success" style="width: 100%;">View Your Account</button>
								</div>
							</div>
						</div>
					</div>
															...
															<div class="d-flex align-items-center justify-content-between">	
																<div class="w-150 mx-20">
																	<div class="progress progress-lg mb-0">
																		<div class="progress-bar bg-warning" role="progressbar" style="width: 94.11%" aria-valuenow="94.11" aria-valuemin="0" aria-valuemax="100"></div>94.11%
																	</div>
																</div>
													...
													<div class="mb-25 pb-25">
														<div class="d-flex align-items-center justify-content-between">									
															...
															<div class="d-flex align-items-center justify-content-between">	
																<div class="w-150 mx-20">
																	<div class="progress progress-lg mb-0">
																		<div class="progress-bar bg-warning" role="progressbar" style="width: 9.91%" aria-valuenow="9.91" aria-valuemin="0" aria-valuemax="100"></div>9.91%
																	</div>
																</div>
													...
													<div class="mb-25 pb-25">
														<div class="d-flex align-items-center justify-content-between">									
															...
															<div class="d-flex align-items-center justify-content-between">	
																<div class="w-150 mx-20">
																	<div class="progress progress-lg mb-0">
																		<div class="progress-bar bg-warning" role="progressbar" style="width: 7.96%" aria-valuenow="7.96" aria-valuemin="0" aria-valuemax="100"></div>7.96%
																	</div>
																</div>
													...
													<div class="mb-25 pb-25">
														<div class="d-flex align-items-center justify-content-between">									
															...
															<div class="d-flex align-items-center justify-content-between">	
																<div class="w-150 mx-20">
																	<div class="progress progress-lg mb-0">
																		<div class="progress-bar bg-warning" role="progressbar" style="width: 6.40%" aria-valuenow="6.40" aria-valuemin="0" aria-valuemax="100"></div>6.40%
																	</div>
																</div>
													...
													<div class="mb-10">
														<div class="d-flex align-items-center justify-content-between">									
															...
															<div class="d-flex align-items-center justify-content-between">	
																<div class="w-150 mx-20">
																	<div class="progress progress-lg mb-0">
																		<div class="progress-bar bg-warning" role="progressbar" style="width: 1.22%" aria-valuenow="1.22" aria-valuemin="0" aria-valuemax="100"></div>1.22%
																	</div>
																</div>
                    ...
                    <div class="chat-msg user">
                        <div class="d-flex align-items-center">
                            <span class="msg-avatar">
                                <img src="../../../images/avatar/2.jpg" class="aAmanda Clarkvatar avatar-lg" alt="">
                            </span>
                            <div class="mx-10">
