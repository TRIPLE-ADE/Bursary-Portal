...
<!-- Mirrored from investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/index3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 07:22:07 GMT -->
<head>
    <meta charset="utf-8">
		...
		<section class="content">
			...
			<div class="row">
				...
				<div class="col-xl-8 col-lg-8">
					<h3 class="pb-10">
						<span>Stock Watchlists</span>
						<span class="float-end"><a class="btn btn-xs btn-primary-light" href="#">View</a></span>
					</h3>
					<div class="card chart_card2">
						<div class="card-body">
							<div class="mt-0">
								<h4 class="fw-500">S&P 500</h4>
								<h3 class="fw-500">4,500.48 <span class="badge badge-pill fs-10 badge-success-light">+1.66%</span></h3>
								<p class="text-fadet">Oct25, 5:26 pm UTC-5, INDEXSP Disclaimer</p>
							</div>
							<div class="p-0">
								<div class="box-controls pull-right mx-20">
							...
							<div dir="ltr">
								<div class="mt-1 chartjs-chart" style="height: 320px;">
									<div id="apexcharts-line2">
									</div>
								</div>
							</div>
						</div> <!-- end card body-->
				...
				<div class="col-xl-4 col-lg-4">
					...
					<div class="box">
						<div class="box-header with-border">
							<h4 class="text-success ml-5 mb-1">S&P 500</h4>
							<ul class="box-controls pull-right d-md-flex d-none">
							  <li class="dropdown">
								<button class="btn btn-primary dropdown-toggle px-10 " data-bs-toggle="dropdown" href="#">24 h</button>
						...
						<div class="box-body p-0">
					  		<div class="media-list media-list-hover media-list-divided">
								...
								<a class="media media-single" href="#">
								  <span class="title text-mute">Primary Exchange</span>
								  <span>Index</span>
								</a>
					  		</div>
				   		</div>
							...
							<div class="row align-items-center">
								<div class="col-6 d-flex align-items-center">
									<div class="bg-primary h-50 w-50 l-h-50 rounded text-center">
										<p class="mb-0 fs-20 w-50 fw-600">M</p>
									</div>
									<div class="d-flex flex-column font-weight-500 mx-10">
										<p class="text-fade hover-primary mb-1  fs-13">Market Cap</p>
										<span class="text-dark fs-19">$40</span>
									</div>
								</div>
								<div class="col-6">
									<div class="text-end" style="position: relative;">
										<div id="campaign-sent-chart" style="min-width: 70px;"></div>
									</div> <!-- end row-->
								</div> <!-- end card-body -->
							</div>
						</div>
													...
													<div>
														...
														<div>29.60%
															<div class="progress progress-lg">
																<div class="progress-bar bg-success" role="progressbar" style="width: 29.60%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
															</div>
														</div>
													</div>
													<div class="text-end">
											...
											<div class="col-lg-8">
												<div class="d-flex justify-content-between">
													<div>
														...
														<div>40.60%
															<div class="progress progress-lg">
																<div class="progress-bar bg-success" role="progressbar" style="width: 40.60%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
															</div>
														</div>
													</div>
													<div class="text-end">
											...
											<div class="col-lg-8">
												<div class="d-flex justify-content-between">
													<div>
														...
														<div>50.60%
															<div class="progress progress-lg">
																<div class="progress-bar bg-success" role="progressbar" style="width: 50.60%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
															</div>
														</div>
													</div>
													<div class="text-end">
											...
											<div class="col-lg-8">
												<div class="d-flex justify-content-between">
													<div>
														...
														<div>89.60%
															<div class="progress progress-lg">
																<div class="progress-bar bg-success" role="progressbar" style="width: 89.60%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
															</div>
														</div>
													</div>
													<div class="text-end">
...
<!-- Mirrored from investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/index3.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 07:22:08 GMT -->
</html>
