...
<!-- Mirrored from investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/auth_login_dark.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 07:24:23 GMT -->
<head>
  <meta charset="utf-8">
					...
					<div class="col-lg-5 col-md-5 col-12">
						<div class="bg-gray-800 rounded10 shadow-lg">
							<div class="content-top-agile p-20 pb-0">
								...
								<p class="mb-0 text-fade">Sign in to continue to InvestX.</p>							
							</div>
							<div class="p-40">
								<form action="https://investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/index.html" method="post">
