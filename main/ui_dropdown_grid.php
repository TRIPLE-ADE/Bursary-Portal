...
<!-- Mirrored from investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/ui_dropdown_grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 07:22:29 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>InvestX - Dashboard  Dropdown Grid </title>
				  ...
				  <div class="box">
					...
					<div class="box-body">
					  <div class="dropdown">
						  ...
						  <div class="dropdown-menu dropdown-grid">
							<a class="dropdown-item" href="#">
							  <img class="icon" src="https://investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/assets/vendor_components/flat-color-icons/SVG/compact_camera.svg" alt="compact_camera.svg"/>
							</a>
							<a class="dropdown-item" href="#">
							  <img class="icon" src="https://investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/assets/vendor_components/flat-color-icons/SVG/stack_of_photos.svg" alt="stack_of_photos.svg"/>
							</a>
							<a class="dropdown-item" href="#">
							  <img class="icon" src="https://investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/assets/vendor_components/flat-color-icons/SVG/folder.svg" alt="folder.svg"/>
							</a>
							<a class="dropdown-item" href="#">
							  <img class="icon" src="https://investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/assets/vendor_components/flat-color-icons/SVG/start.svg" alt="start.svg"/>
							</a>
							<a class="dropdown-item" href="#">
							  <img class="icon" src="https://investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/assets/vendor_components/flat-color-icons/SVG/music.svg" alt="music.svg"/>
							</a>
							<a class="dropdown-item" href="#">
							  <img class="icon" src="https://investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/assets/vendor_components/flat-color-icons/SVG/news.svg" alt="news.svg"/>
							</a>
							<a class="dropdown-item" href="#">
							  <img class="icon" src="https://investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/assets/vendor_components/flat-color-icons/SVG/contacts.svg" alt="contacts.svg"/>
							</a>
							<a class="dropdown-item" href="#">
							  <img class="icon" src="https://investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/assets/vendor_components/flat-color-icons/SVG/download.svg" alt="download.svg"/>
							</a>
							<a class="dropdown-item" href="#">
							  <img class="icon" src="https://investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/assets/vendor_components/flat-color-icons/SVG/settings.svg" alt="settings.svg"/>
							</a>
						  </div>
						</div>
					</div>
					...
					<div class="box-body">
					  <div class="dropdown">
						  ...
						  <div class="dropdown-menu dropdown-grid cols-4">
							...
							<a class="dropdown-item" href="#">
							  <img class="icon" src="https://investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/assets/vendor_components/flat-color-icons/SVG/phone.svg" alt="phone.svg"/>
							...
							<a class="dropdown-item" href="#">
							  <img class="icon" src="https://investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/assets/vendor_components/flat-color-icons/SVG/calculator.svg" alt="calculator.svg"/>	
							  <span class="title">Calculator</span>
							</a>
							<a class="dropdown-item" href="#">
							  <img class="icon" src="https://investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/assets/vendor_components/flat-color-icons/SVG/alarm_clock.svg" alt="alarm_clock.svg"/>	
