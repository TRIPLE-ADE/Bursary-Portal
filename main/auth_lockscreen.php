...
<!-- Mirrored from investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/auth_lockscreen.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 07:24:23 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>InvestX - Lockscreen </title>
					...
					<div class="col-lg-5 col-md-5 col-12">
						<div class="bg-white rounded10 shadow-lg">
							<div class="content-top-agile px-20 pt-40 pb-0">
								...
								<h2 class="text-primary fw-600">Bursary Unit</h2>
								<p class="mb-5 text-fade">Enter the Verification Number sent to you via Email</p>	
							</div>
								...
								<form action="main/index.html" method="post">
									<div class="form-group">
										<div class="input-group mb-3">
											...
											<input type="text" class="form-control ps-15 bg-transparent" placeholder="Verification Number">
										</div>
									</div>
									  <div class="row">
