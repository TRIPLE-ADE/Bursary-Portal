...
<!-- Mirrored from investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/email_change_pass_dark.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 07:25:02 GMT -->
<head>
<title></title>
                    ...
                    <tr>
                      <td bgcolor="#293146" align="center" style="padding: 20px 30px 30px 30px;">
                        <table border="0" cellspacing="0" cellpadding="0">
                          <tr>
							  <td align="center" style="border-radius: 3px;" bgcolor="#46bc5c"><a href="#" target="_blank" style="font-size: 18px; font-family: 'Poppins', sans-serif; color: #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; padding: 12px 50px; border-radius: 5px; border: 1px solid #46bc5c; display: inline-block;">Reset Password</a></td>
                          </tr>
                        </table>
                      </td>
                    </tr>
