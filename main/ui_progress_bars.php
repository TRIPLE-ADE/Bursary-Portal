...
<!-- Mirrored from investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/ui_progress_bars.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 07:22:29 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>InvestX - Dashboard  Progress Bars </title>
							...
							<div class="tab-content">
								<div class="tab-pane show active" id="height-progress-preview">
									...
									<div class="progress progress-lg mb-2">
										<div class="progress-bar bg-warning w-100" role="progressbar" style="width: 75%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
									</div>
