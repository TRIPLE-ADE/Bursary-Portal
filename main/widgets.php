...
<!-- Mirrored from investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/widgets.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 07:23:37 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>InvestX - Dashboard  Widgets</title>
		...
		<section class="content">
		  ...
		  <div class="row">				  
						...
						<div class="flex-grow-1 pb-15">	
							<div class="d-flex align-items-center pe-2 mb-30">							
								...
								<div class="bg-info-light h-50 w-50 l-h-50 rounded text-center">
									  <img src="https://investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/images/svg-icon/color-svg/001-glass.svg" class="h-30 align-self-center" alt="" >
								</div>							
							</div>
						...
						<div class="flex-grow-1 pb-15">	
							<div class="d-flex align-items-center pe-2 mb-30">							
								...
								<div class="bg-danger-light h-50 w-50 l-h-50 rounded text-center">
									  <img src="https://investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/images/svg-icon/color-svg/008-python.svg" class="h-30 align-self-center" alt="" >
								</div>							
							</div>
						...
						<div class="flex-grow-1 pb-15">	
							<div class="d-flex align-items-center pe-2 mb-30">							
								...
								<div class="bg-primary-light h-50 w-50 l-h-50 rounded text-center">
									  <img src="https://investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/images/svg-icon/color-svg/007-color-palette.svg" class="h-30 align-self-center" alt="" >
								</div>							
							</div>
			...
			<div class="col-xl-6"> 
				<div class="box">
					<div class="box-body d-flex p-0">
						<div class="flex-grow-1 p-30 flex-grow-1 bg-img" style="background-position: left bottom; background-size: auto 80%; background-image: url(https://investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/images/svg-icon/color-svg/custom-2.svg)">
							<div class="row">
			...
			<div class="col-xl-3">
				<div class="box">
					<div class="box-body d-flex p-0">
						<div class="flex-grow-1 bg-danger p-30 flex-grow-1 bg-img" style="background-position: calc(100% + 0.5rem) bottom; background-size: auto 100%; background-image: url(https://investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/images/svg-icon/color-svg/custom-3.svg)">
			...
			<div class="col-xl-3">
				<div class="box">
					<div class="box-body d-flex p-0">
					<div class="flex-grow-1 bg-primary p-30 flex-grow-1 bg-img" style="background-position: calc(100% + 0.5rem) bottom; background-size: auto 100%; background-image: url(https://investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/images/svg-icon/color-svg/custom-4.svg)">
			...
			<div class="col-xl-4">				
				<div class="box">
					<div class="card-body d-flex p-0">
						<div class="flex-grow-1 px-30 pt-50 pb-100 flex-grow-1 bg-img min-h-350" style="background-position: calc(100% + 0.5rem) bottom; background-size: 30% auto; background-image: url(https://investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/images/svg-icon/color-svg/custom-5.svg)">
			...
			<div class="col-xl-4">
				<div class="box">
					<div class="box-body d-flex p-0">
						<div class="flex-grow-1 bg-info px-30 pt-50 pb-100 flex-grow-1 bg-img min-h-350" style="background-position: right bottom; background-size: 40% auto; background-image: url(https://investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/images/svg-icon/color-svg/custom-6.svg)">
			...
			<div class="col-xl-4">
				<div class="box">
					<div class="box-body d-flex p-0">
						<div class="flex-grow-1 bg-danger px-30 pt-50 pb-100 flex-grow-1 bg-img min-h-350" style="background-position: calc(100% + 0.5rem) bottom; background-size: 30% auto; background-image: url(https://investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/images/svg-icon/color-svg/custom-7.svg)">
							...
							<table class="table no-border table-vertical-center">
								...
								<tbody>
									...
									<tr>
										<td>
											<div class="bg-lightest h-50 w-50 l-h-50 rounded text-center">
												  <img src="https://investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/images/svg-icon/color-svg/006-pottery.svg" class="h-30" alt="">
											</div>
										</td>
										<td>
							...
							<table class="table no-border">
								...
								<tbody>
									<tr>										
										<td>
											<div class="bg-lightest h-50 w-50 l-h-50 rounded text-center">
												  <img src="https://investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/images/svg-icon/color-svg/007-color-palette.svg" class="h-30" alt="">
											</div>
										</td>
										<td>
											<a href="#" class="text-dark fw-600 hover-primary fs-16">Vivamus consectetur</a>
...
<!-- Mirrored from investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/widgets.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 07:23:40 GMT -->
</html>
