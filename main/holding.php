...
<!-- Mirrored from investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/holding.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 07:25:29 GMT -->
<head>
    <meta charset="utf-8">
					...
					<div class="box">
				  		<div class="box-body">
				  			<div class="d-flex justify-content-between align-items-center mb-2">
								<div>
									<h3 class="mb-0">My Insurances</h3>
								</div>
								<div class="mx-lg-5">
									<a href="index.html" class="waves-effect waves-light btn btn-outline btn-primary mt-2 mx-lg-5">Buy Insurances</a>
								</div>
							</div>
							<div class="row justify-content-center">
								<div class="row">
									<div class="col-lg-6 col-12">
										<div class="box box-body border border-light pull-up">
						  					<div class="text-white box-body bg-img text-center" style="background-image: url(../../../images/gallery/creative/img-12.jpg); height: 12.1rem;"></div>
						  				</div>
						  			</div>
						  			<div class="col-lg-6 col-12">
						  				<div class="box box-body border border-light pull-up mb-1">
							  				<div>
												<a href="#" class="media media-single p-0 mb-3">
													<img class="avatar pull-left" src="../../../images/avatar/4.jpg" alt="" />
													<div>
														<h3 class="mb-0">Auto Insurances</h3>
													</div>
												</a>
												<p class="px-2">Mercedes GLA(2021)</p>
												<div class="row">
													<div class="col-lg-6">
														<p class="text-light px-2">Day Left</p>
														<input type="Date" name="date" class="form-control">
													</div>
													<div class="col-lg-6">
														<p class="text-light pull-right"></p><br>	
													</div>
												</div>
											</div>
										</div>
					  		...
					  		<div class="row justify-content-center m-0">
					  			<div class="col-xl-6 col-12">
									<div class="box box-body border border-light pull-up">
					  					<div class="d-flex">
											<span class="glyphicon glyphicon-home" style="font-size: 50px; padding: 15px 6px; color: #46bc5c;"></span>
											<div>
												<h2 class="px-4">House</h2>
												<h2 class="px-4">Protection</h2>
					  						</div>
										</div>
									</div>
								</div>
								...
								<div class="">
									<div class="box-body">
										<div style="display: grid;">
											<div class="dropdown">
												<button class="btn btn-outline btn-primary dropdown-toggle" style="width: 100%;" type="button" data-bs-toggle="dropdown">Last Quarter</button>
												<div class="dropdown-menu">
								...
								<div class="">
									<div class="box-body">
										<div style="cursor: pointer;display: grid;">
											<button class="btn btn-outline btn-primary" >All Member</button>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="d-flex align-items-center justify-content-between">
								<div class="d-flex align-items-center">
									<div class="me-15 bg-primary h-50 w-50 l-h-60 rounded text-center">
										<span class="fs-24"><i class="mdi mdi-folder-multiple"></i></span>
									</div>
									<div class="d-flex flex-column fw-500">
										<a href="#" class="text-dark hover-primary mb-1 fs-16">Insurances <i class="mdi mdi-arrow-up text-fade"> 2</i></a>
										<span class="text-fade">Last Modified : 2 Oct</span>
									</div>
								</div>
								<a href="#">
						...
						<div class="box-body mb-20">
							<div class="d-flex align-items-center justify-content-between">
								<div class="d-flex align-items-center">
									...
									<div class="d-flex flex-column fw-500">
										<a href="#" class="text-dark hover-primary mb-1 fs-16">Payments <i class="mdi mdi-arrow-down text-fade"> 7</i></a>
										<span class="text-fade">Last Modified : 14 jul</span>
									</div>
								</div>
								<a href="#">
									<span class="icon-Arrow-right fs-24"><span class="path1"></span><span class="path2"></span></span>
						...
						<div class="box-body mb-20">
							<div class="d-flex align-items-center justify-content-between">
								<div class="d-flex align-items-center">
									...
									<div class="d-flex flex-column fw-500">
										<a href="#" class="text-dark hover-primary mb-1 fs-16">Home</a>
										<span class="text-fade"><i class="mdi mdi-arrow-up"> 4</i></span>
									</div>
								</div>
								<a href="#">
									<span class="icon-Arrow-right fs-24"><span class="path1"></span><span class="path2"></span></span>
				...
				<div class="col-xl-12">
					<div class="card">
						<div class="card-header">
							<h3 class="card-title mb-0">Ttansaction</h3>
								...
								<table id="example2" class="table" style="width:100%">
									<thead>
										<tr>
											...
											<th>Issurance</th>
											<th>Invoice</th>
											<th style="padding: 30px 35px 13px 13px;">Due Date</th>
											<th>Value</th>
											<th>Status</th>
										</tr>
									</thead>
									<tbody class="text-fade">
										...
										<tr>
											...
											<td>12 Sept 2021</td>
											<td>$150</td>
											<td><span class="badge bg-warning-light">Late</span></td>
										</tr>
										<tr>
											<td>Lio</td>
											<td>1237912503</td>
											...
											<td>02 June 2021</td>
											<td>$200</td>
											<td><span class="badge bg-danger-light">Unpaid</span></td>
										</tr>
										<tr>
											<td>Jeremi</td>
											<td>1597536548</td>
				...
				<div class="col-xl-8 col-12">
					<div class="box">
						<div class="box-body">
							...
							<div id="investment-chart2"></div>
						</div>
					</div>
				</div>
				<div class="col-xl-4 col-12">
					<div class="box no-shadow mb-15 bg-transparent">
						<div class="box-header no-border px-0">
							<h3 class="box-title">Best Insurance</h3>
							<div class="card-actions float-end">
								<a href="#">View More</a>
							</div>		
						</div>
							...
							<div class="box-body">
								<div class="d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center">
										...
										<div class="d-flex flex-column fw-500">
											<a href="#" class="text-dark hover-primary mb-1 fs-16">Prudential Insurance</a>
											<span class="text-fade">Life Insurance</span>
										</div>
									</div>
									<div class="text-right">
										<span class="text-success pull-right">+3.80%</span><br>
										<span class="text-fade pull-right">618,551</span>
										<P class="text-fade mb-0">Customer</P>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="box-body">
								<div class="d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center">
										...
										<div class="d-flex flex-column fw-500">
											<a href="#" class="text-dark hover-primary mb-1 fs-16">Adira Insurance</a>
											<span class="text-fade">General Insurance</span>
										</div>
									</div>
									<div class="text-right">
										<span class="text-info pull-right">+2,76</span><br>
										<span class="text-fade pull-right">553,689</span>
										<P class="text-fade mb-0">Customer</P>
									</div>
								</div>
							</div>
							...
							<div class="box-body">
								<div class="d-flex align-items-center justify-content-between">
									<div class="d-flex align-items-center">
										...
										<div class="d-flex flex-column fw-500">
											<a href="#" class="text-dark hover-primary mb-1 fs-16">Progressive Insurance</a>
											<span class="text-fade">Auto Insurance</span>
										</div>
									</div>
									<div class="text-right">
										<span class="text-danger pull-right">-1,06%</span><br>
										<span class="text-fade pull-right">413,730</span>
										<P class="text-fade mb-0">Customer</P>
									</div>
								</div>
							</div>
			...
			<div class="row">
				<div class="col-xxl-6 col-lg-6">
					<div class="card widget-flat">
						<div class="card-body">
							<h3 class="text-muted text-uppercase mt-0" title="Revenue">Deposite Money From Week</h3>
							<div id="spark1" class="apex-charts mb-3"></div>
							<div class="row text-center">
								<div class="col-4">
									<h6 class="text-muted d-block">Last Week</h6>
									<p class="fs-18 mb-0">$500</p>
								</div>
								<div class="col-4">
								...
								<div class="col-4">
									<h6 class="text-muted d-block">This Month</h6>
				...
				<div class="col-lg-6 col-12">
					<div class="row">
						<div class="col-md-6">
							<a class="box box-link-pop" href="javascript:void(0)">
								<div class="box-body py-25">
									<p class="fs-40">
										<strong>1000<sup class="text-primary">$</sup></strong>
										<p>Total Value Of Disbursement</p>
									</p>
									<div class="d-flex justify-content-between">
										<p>Policy</p>
										<p class="pull-right">400<sup>$</sup></p>
									</div>
									<div class="progress">
									...
									<div class="d-flex justify-content-between">
										<p>Policy</p>
										<p class="pull-right">800<sup>$</sup></p>
									</div>
									<div class="progress">
						...
						<div class="col-md-6">
							<a class="box box-link-pop" href="javascript:void(0)">
								<div class="box-body py-25">
									<p class="fs-40">
										<strong>1200<sup class="text-primary">$</sup></strong>
										<p>Total Value Of Disbursement</p>
									</p>
									<div class="d-flex justify-content-between">
										<p>Policy</p>
										<p class="pull-right">1100<sup>$</sup></p>
									</div>
									<div class="progress">
										<div class="progress-bar" role="progressbar" style="width: 25%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">25%</div>
									</div>
									<div class="d-flex justify-content-between">
										<p>Policy</p>
										<p class="pull-right">1400<sup>$</sup></p>
									</div>
									<div class="progress">
										<div class="progress-bar bg-success" role="progressbar" style="width: 50%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">50%</div>
									</div>
...
<!-- Mirrored from investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/holding.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 07:25:30 GMT -->
</html>
