...
<!-- Mirrored from investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/auth_login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 07:24:22 GMT -->
<head>
  <meta charset="utf-8">
					...
					<div class="col-lg-5 col-md-5 col-12">
						<div class="bg-white rounded10 shadow-lg">
							<div class="content-top-agile p-20 pb-0">
								...
								<p class="mb-0 text-fade">Sign in to continue access Bursary Portal</p>							
							</div>
							<div class="p-40">
									...
									<!-- <div class="form-group">
									  ...
									  <div class="row">
										...
										<div class="col-12 text-center">
										  <a href="auth_lockscreen.html"><button type="submit" class="btn btn-primary w-p100 mt-10">SIGN IN</button></a>
										</div>
										<!-- /.col -->
									  </div>
								</form>	
...
<!-- Mirrored from investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/auth_login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 07:24:23 GMT -->
</html>
