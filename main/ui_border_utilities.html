...
<!-- Mirrored from investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/ui_border_utilities.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 07:22:29 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>InvestX - Dashboard  Border Class Utilities </title>
		  ...
		  <div class="box">
			...
			<div class="box-body">
			  <div class="row">
				...
				<div class="col-12">
					<p class="text-fade">You can add solid borders to an element using following classes. You're able to change the border color using <a href="https://investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/content/utilities-color.html">border color utility classes</a>.</p>
