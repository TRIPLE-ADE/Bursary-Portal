...
<!-- Mirrored from investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/index7.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 07:22:12 GMT -->
<head>
    <meta charset="utf-8">
 ...
 <link rel="stylesheet" href="../src/css/dashboard7.css">
					...
					<div class="box">
						<div class="box-body">
							<div class="row">
									...
									<div>
										...
										<div class="row pt-40">
											<div class="col-lg-4 col-md-4 col-sm-4">
												<input type="search" class="form-control px-10  h-50 mb-5 bg-transparent border-0 bb-2 fs-18" placeholder="Search">
											</div>
											<div class="col-lg-5 col-md-5 col-sm-5">
												<div class="d-flex">
													<a href="#" class="bg-transparent px-10  h-50 mb-5  border-0 bb-2 p-5 fs-18 text-fade w-p100" data-bs-toggle="dropdown">Home <i class="ms-15 mt-5 fa fa-angle-down float-right"></i></a>
												  	<div class="dropdown-menu dropdown-menu-left w-p25 w-md-p35" style="">
											...
											<div class="col-lg-3 col-md-3 col-sm-3">
												<div class="text-center">
													<button class="btn btn-dark rounded-0 h-50 fs-18 px-20 py-5" type="button">Search</button>
												</div>
											</div>
										</div>
									</div>
									<div class="index-section">
										<div class="row">
											<div class="col-lg-3 col-md-6 col-sm-6">
												<div class="box pull-up index-one">
													<div class="box-body ">
														<h5 class="fw-600">Index</h5>
														<div class="text-end mt-60">
															<p class="mb-5 text-success fw-600">1500</p>
															<p class="fw-600 mb-15"><span class="glyphicon glyphicon-triangle-top me-5 text-success "> </span> 1.5%</p>
															<h2 class="fw-600">41045.12</h2>
														</div>
													</div>
												</div>
											</div>
											<div class="col-lg-3 col-md-6 col-sm-6">
												<div class="box pull-up index-two">
													<div class="box-body">
														<h5 class="fw-600">Your<br>Investment</h5>
														<div class="text-end mt-100">
															<h2 class="fw-600">$5000</h2>												
														</div>
													</div>
												</div>
											</div>
											<div class="col-lg-3 col-md-6 col-sm-6">
												<div class="box pull-up index-three">
													<div class="box-body">
														<h5 class="fw-600">Current<br>Value</h5>
														<div class="text-end">
															<h2 class="fw-600 mt-100">$8000</h2>													
														</div>
													</div>
												</div>
											</div>
											<div class="col-lg-3 col-md-6 col-sm-6">
												<div class="box pull-up index-four">
													<div class="box-body">
														<h5 class="fw-600">ROI</h5>
														<div class="text-end">
															<h2 class="fw-600 mt-120">+30.2%</h2>												
														</div>
													</div>
												</div>
											</div>
									...
									<div class="mb-10">
										<div class="tab-content">
											<div class="tab-pane show active" id="default-tabs-preview">
												<ul class="nav nav-tabs mb-3 border-0 fund-section">
													<li class="nav-item">
														<a href="#home" data-bs-toggle="tab" aria-expanded="false" class="nav-link active border-0">
															<h2 class="d-md-block fw-600">Invested Funds</h2>
														</a>
													</li>
													<li class="nav-item">
														<a href="#profile" data-bs-toggle="tab" aria-expanded="true" class="nav-link border-0">
															<h2 class="d-md-block fw-600">Recommended</h2>
														</a>
													</li>
												</ul>
												<div class="table-scroll-contant">
													<small>***Drag a table to scroll***</small>
												</div>
																...
																<table class="table no-border table-vertical-center">
																	...
																	<tbody>
																		<tr>
																			...
																			<td>
																				<h3 class="text-dark fw-600 hover-primary m-0">Flexi term</h3>
																				<span class="text-fade d-block fs-14">Large Cap</span>
																			</td>
																			<td>
																				<h3 class="m-0">125876</h3>
																				<span class="text-fade fs-14">Personal account</span>
																			</td>
																			<td>
																				<h3 class="m-0">10 Aug 22</h3>
																				<span class="text-fade fs-14">Last payment</span>
																			</td>
																			<td>
																				<h3 class="text-dark fw-600">$51254</h3>
																			</td>
																		</tr>
																		<tr>
																			<td>
																			...
																			<td>
																				<h3 class="text-dark fw-600 hover-primary m-0">Divesified ETF</h3>
																				<span class="text-fade d-block fs-14">Mid Cap</span>
																			</td>
																			<td>
																				<h3 class="m-0">362458</h3>
																				<span class="text-fade fs-14">Personal account</span>
																			</td>
																			<td>
																				<h3 class="m-0">15 Aug 22</h3>
																				<span class="text-fade fs-14">Last payment</span>
																			</td>
																			<td>
																				<h3 class="text-dark fw-600">$42548</h3>
																			</td>
																		</tr>
																		<tr>
																			<td>
																			...
																			<td>
																				<h3 class="text-dark fw-600 hover-primary m-0">Growth Fund</h3>
																				<span class="text-fade d-block fs-14">Large Cap</span>
																			</td>
																			<td>
																				<h3 class="m-0">145789</h3>
																				<span class="text-fade fs-14">Personal account</span>
																			</td>
																			<td>
																				<h3 class="m-0">18 Aug 22</h3>
																				<span class="text-fade fs-14">Last payment</span>
																			</td>
																			<td>
																				<h3 class="text-dark fw-600">$48796</h3>
																			</td>
																		</tr>
																		<tr>
																			<td>
																			...
																			<td>
																				<h3 class="text-dark fw-600 hover-primary m-0">Income Fund</h3>
																				<span class="text-fade d-block fs-14">Large Cap</span>
																			</td>
																			<td>
																				<h3 class="m-0">479658</h3>
																				<span class="text-fade fs-14">Personal account</span>
																			</td>
																			<td>
																				<h3 class="m-0">20 Aug 22</h3>
																				<span class="text-fade fs-14">Last payment</span>
																			</td>
																			<td>
																				<h3 class="text-dark fw-600">$41789</h3>
																			</td>
																		</tr>
																	</tbody>
																</table>
															...
															<div class="table-responsive">
																<table class="table no-border table-vertical-center">
																	<thead>
																		<tr class="bb-1">
																			<th class="p-0" style="width: 50px"></th>
																			<th class="p-5 px-15" style="min-width: 150px"><h3>Fund Name</h3></th>
																			<th class="p-5 px-15" style="min-width: 215px"><h3>3-year Return (%)*</h3></th>
																			<th class="p-5 px-15" style="min-width: 215px"><h3>5-year Return (%)*</h3></th>
																		</tr>
																	</thead>
																	<tbody>
																		<tr>
								...
								<div class="col-xl-4">
									<div>
										<h2 class="fw-600">Investment Growth</h2>
										<div>
											<div class="no-border pt-50">
												<h5 class="box-title">Activity</h5>
												<h5 class="pull-right text-fade">Last week</h5>
											</div>
											<div id="revenue6"></div>
										</div>
										<div class="pt-30">
											<h2 class="fw-600 mb-30">Your Portfolio</h2>
											<div class="box image-box" >
												<div class="box-body">
													<div class="row">
														<div class="col-lg-6 col-md-6 col-sm-6 text-center align-self-center">
															<h1 class="text-dark hover-primary mb-0">20% Off</h1>
															<span class="fs-14">Our Your Invest</span>
														</div>
														<div class="col-lg-6 col-md-6 col-sm-6"> 
															<div class="text-center">
																<img src="../../../images/img-min.jpg" class="img-fluid w-75">
															</div>
														</div>
													</div>
												</div>
											...
											<div class="row">
												<div class="col-lg-6 col-md-6 col-sm-6">
													<div class="box pull-up py-50 index-four">
														<div class="box-body text-center p-15">
															<h5 class="mb-30">Demographic</h5>
															<h1>30</h1>
														</div>
													</div>
												</div>
												<div class="col-lg-6 col-md-6 col-sm-6">
													<div class="box pull-up py-50 index-one">
														<div class="box-body text-center p-15">
															<h5 class="mb-30">Earning</h5>
															<h1 class="fw-600">$5897 <i class="ti-arrow-circle-up text-success fs-20 fw-600"></i></h1>
														</div>
													</div>
												</div>
											</div>
								...
								<div class="col-xl-12">
									<div class="row">
										<div class="col-lg-6 col-12">
											<div>
												<div class="box-body">
													<h2 class="fw-600">Sectors Holding In This Online Fund</h2>
													<div>
										...
										<div class="col-lg-6 col-12">
											<div>
												<div class="box-body">
													<h2 class="fw-600">Companies holding in this online Fund</h2>
													<div>
														<ul class="nav nav-tabs nav-bordered mb-3">
															<li class="nav-item be-1 active">
...
<!-- ./wrapper -->
	...
	<script src="../src/js/pages/dashboard7.js"></script>
</body>

<!-- Mirrored from investx-admin-template.multipurposethemes.com/New_InvestX-main-files/html/template/vertical-light/main/index7.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Jan 2023 07:22:13 GMT -->
</html>
